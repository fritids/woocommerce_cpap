...
function flatsome_scripts() {
	...
	/* styles */
	wp_enqueue_style( 'flatsome-icons', get_template_directory_uri() .'/css/fonts.css', array(), '1.9.1', 'all' );
	wp_enqueue_style( 'flatsome-animations', get_template_directory_uri() .'/css/animations.css', array(), '1.9.1', 'all' );

	/* main style */
	wp_enqueue_style( 'flatsome-style', get_stylesheet_uri(), array(), '1.9.1', 'all');	

	/* JS libaries */
	wp_enqueue_script( 'flatsome-modernizer', get_template_directory_uri() .'/js/modernizr.js?v=1.9.1', array( 'jquery' ), '20120202', true );
 	wp_enqueue_script( 'flatsome-plugins', get_template_directory_uri() .'/js/plugins.js?v=1.9.1', array( 'jquery' ), '20120202', true );
	wp_enqueue_script( 'flatsome-iosslider', get_template_directory_uri() .'/js/jquery.iosslider.min.js?v=1.9.1', array( 'jquery' ), '20120202', true );
	wp_enqueue_script( 'flatsome-magnific-popup', get_template_directory_uri() .'/js/jquery.magnific-popup.js?v=1.9.1', array( 'jquery' ), '20120202', true );
	wp_enqueue_script( 'flatsome-theme-js', get_template_directory_uri() .'/js/theme.js?v=1.9.1', array( 'jquery' ), '20120202', true );
...
add_filter( 'woocommerce_product_tabs', 'woocommerce_custom_product_tabs', 50 );
...
include_once('inc/shortcodes/hotspot.php');
...
if ( ! function_exists( 'woocommerce_custom_product_tabs' ) ) {
	 ...
	 * @return array
	 */
	function woocommerce_custom_product_tabs( $tabs = array() ) {
		global $product, $post;
              

		// Addtional Specification Tab - shows specification attribute
		if ( $product && ( $product->has_attributes() || ( $product->enable_dimensions_display() && ( $product->has_dimensions() || $product->has_weight() ) ) ) ) {
			$tabs['additional_specifications'] = array(
                ...
                // Addtional Specification Tab - shows specification attribute
		if ( $product && ( $product->has_attributes() || ( $product->enable_dimensions_display() && ( $product->has_dimensions() || $product->has_weight() ) ) ) ) {
			$tabs['additional_resources'] = array(
				'title'    => __( 'Resources', 'woocommerce' ),
				'priority' => 22,
				'callback' => 'woocommerce_product_resources_tab'
			);
		}
...
if ( ! function_exists( 'woocommerce_product_resources_tab' ) ) {
	 ...
	 * @return void
	 */
	function woocommerce_product_resources_tab() {
		wc_get_template( 'single-product/tabs/resources.php' );
	}
}
