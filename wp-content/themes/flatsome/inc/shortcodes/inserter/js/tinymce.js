		...
		createControl : function(btn, e) {
			if ( btn == "shortcodes_button" ) {
	            ...
	            btn.onRenderMenu.add(function (c, b) {
					...
					a.render( b, "Row Animated - 4 Columns", "row_4_animated" );
					...
					a.render( b, "Featured Items Slider", "ux_featured_items_slider" );
					a.render( b, "Featured Items Grid", "ux_featured_items_grid" );
					a.render( b, "Featured Items Grid - Style 2", "ux_featured_items_grid_2" );
				});
		...
		render : function(ed, title, id) {
			ed.add({
				...
				onclick: function () {
					...
					if(id == "row_4_animated") {
						tinyMCE.activeEditor.selection.setContent('[row animate="fadeInUp"] <br> [col span="1/4" animate="fadeIn"] Col 1 [/col]  <br>[col span="1/4" animate="fadeInLeft" delay="0.3s"] Col 2 [/col] <br> [col span="1/4" animate="flipInX" delay="0.6s"] Col 3 [/col] <br> [col span="1/4" animate="flipInY" delay="0.9s"] Col 4 [/col] <br> [/row]');
					}
					...
					if(id == "blog_posts") {
						tinyMCE.activeEditor.selection.setContent('[blog_posts posts="6" columns="3" image_height="200px" show_date="true"]');
					}
					...
					if(id == "product_pinterest") {
						tinyMCE.activeEditor.selection.setContent('[products_pinterest_style products="" cat="category-slug" columns="4"]');
					}
					...
					if(id == "ux_featured_items_slider") {
						tinyMCE.activeEditor.selection.setContent('[featured_items_slider style="1" items="8" cat="" height="250px"]');
					}

					if(id == "ux_featured_items_grid") {
						tinyMCE.activeEditor.selection.setContent('[featured_items_grid style="1" items="8" cat="" height="250px"]');
					}

					if(id == "ux_featured_items_grid_2") {
						tinyMCE.activeEditor.selection.setContent('[featured_items_grid style="2" items="8" cat="" height="250px"]');
					}
