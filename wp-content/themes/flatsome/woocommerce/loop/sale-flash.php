...
?>
<?php if ($product->is_on_sale() && !$flatsome_opt['sale_bubble_percentage'] || !isset($flatsome_opt['sale_bubble_percentage']) ) : ?>
...
<?php if ($product->is_on_sale() && $flatsome_opt['sale_bubble_percentage'] && $product->product_type == 'variable') : ?>
 <div class="callout <?php echo $flatsome_opt['bubble_style']; ?>">
        <div class="inner">
